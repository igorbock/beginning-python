# Add to the existing password, two random symbols.

# The ASCII values for the symbols we will use are 33 to 47.
...
print(f"{chr(num1)}{chr(num2)}{chr(num3)}{chr(num4)}{chr(num5)}{chr(num6)}{chr(num7)}{chr(num8)}")