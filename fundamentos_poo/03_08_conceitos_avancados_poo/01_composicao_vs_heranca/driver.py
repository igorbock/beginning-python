# Neste desafio, você implementará um sistema de biblioteca de mídia usando tanto padrões de herança 
# quanto de composição.

# Você precisa editar os seguintes arquivos, seguindo os comentários TODO em cada um:

# media.py, book.py, movie.py, musicalbum.py - Para a implementação de herança
# mediaitem.py, bookcomposition.py, moviecomposition.py, musicalbumcomposition.py - Para a implementação de 
# composição
# Cada tipo de mídia deve ter:

# Título, criador (autor/diretor/artista) e atributos de ano
# Método display_info() apropriado
