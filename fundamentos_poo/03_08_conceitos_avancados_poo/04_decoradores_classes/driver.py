# Neste desafio, você implementará um decorador de classe que adiciona funcionalidade de rastreamento de 
# chamadas de métodos.

# decorator.py - Implemente o decorador de classe add_counter
# calculator.py - Contém as classes que usarão seu decorador
# O arquivo driver.py contém cenários de teste extensivos que validarão sua implementação contra vários casos de uso, 
# padrões de herança e casos de borda. Você não precisa modificar este arquivo, mas examiná-lo ajudará 
# você a entender o comportamento esperado.
