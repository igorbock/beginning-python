# Neste desafio, você implementará uma classe Temperature com funcionalidade específica, aproveitando um 
# framework de testes abrangente.

# Você precisa editar apenas o arquivo temperature.py, seguindo os comentários TODO que 
# guiam sua implementação. A classe deve incluir:

# Uma variável de classe para rastrear leituras de temperatura
