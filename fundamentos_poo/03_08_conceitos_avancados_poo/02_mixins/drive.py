# Neste desafio, você implementará um sistema de e-commerce simples usando mixins e herança.

# Implemente as classes necessárias nestes arquivos (siga os comentários TODO em cada arquivo):

# printablemixin.py - Crie o PrintableMixin com funcionalidade de saída formatada
# discountmixin.py - Implemente o DiscountMixin para cálculos de redução de preço
# shippablemixin.py - Construa o ShippableMixin para recursos de peso e custo de envio
# product.py - Desenvolva a classe base Product com herança de mixin apropriada
# physicalproduct.py - Crie a classe PhysicalProduct estendendo Product
# digitalproduct.py - Implemente a classe DigitalProduct com comportamento de desconto especial
