# Neste desafio, você implementará um sistema de personagens de RPG em múltiplos 
# arquivos com cobertura abrangente de testes.

# character.py - Implemente a classe base Character
# warrior.py - Implemente a subclasse Warrior
# mage.py - Implemente a subclasse Mage
# rogue.py - Implemente a subclasse Rogue
# ability.py - Implemente a classe Ability
# Cada arquivo contém comentários TODO detalhados orientando sua implementação. 
# Siga estes comentários para garantir que seu código atenda a todos os requisitos.
