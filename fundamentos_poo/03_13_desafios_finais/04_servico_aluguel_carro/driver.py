# Neste desafio, você implementará um sistema de aluguel de veículos. O sistema modela veículos, 
# aluguéis e uma agência de aluguel com herança e encapsulamento adequados.
...
# Siga esses comentários para garantir que seu código atenda a todos os requisitos.
