# Neste desafio, você construirá um sistema bancário com múltiplos tipos de conta, transações e um 
# gerente de banco central.

# Implemente o sistema bancário completando os itens TODO nestes arquivos:

# transaction.py - Classe Transaction para registrar atividades financeiras
# account.py - Classe base abstrata Account com funcionalidades comuns
# savingsaccount.py - Implementação de SavingsAccount com juros e saldo mínimo
# checkingaccount.py - Implementação de CheckingAccount com recursos de cheque especial
# bank.py - Classe Bank para gerenciar contas e transferências
