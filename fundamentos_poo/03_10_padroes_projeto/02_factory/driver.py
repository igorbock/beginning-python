# Neste desafio, você implementará um sistema de fábrica de formas usando um design orientado a objetos adequado
# com herança e polimorfismo.

# Complete a implementação nos seguintes arquivos:

# shape.py - Classe base Shape
# circle.py - Implementação de Circle
# rectangle.py - Implementação de Rectangle
# triangle.py - Implementação de Triangle
# shapefactory.py - Classe Factory para criar formas
# Cada arquivo contém comentários TODO detalhados para guiar sua implementação. 
# Siga estes comentários cuidadosamente para garantir que seu código atenda a todos os requisitos.
