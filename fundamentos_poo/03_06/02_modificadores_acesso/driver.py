# Neste desafio, você implementará uma classe FileManager que demonstra os modificadores de acesso do 
# Python (público, protegido e privado) enquanto experimenta os benefícios de testes abrangentes.

# Edite filemanager.py para implementar a classe FileManager seguindo os comentários TODO. 
# O arquivo contém instruções detalhadas para implementar:

# Métodos públicos para operações de arquivo
# Métodos protegidos (com prefixo de sublinhado simples)
# Métodos privados (com prefixo de duplo sublinhado)
# Interações de métodos demonstrando encapsulamento
