# Neste desafio, você implementará uma classe BankAccount que demonstra o uso adequado dos níveis de 
# acesso público, protegido e privado em Python.

# bankaccount.py - Contém a definição da classe com comentários TODO que guiam sua implementação
# Siga os comentários TODO em bankaccount.py para implementar a funcionalidade necessária
# Implemente os níveis de acesso adequados (público, protegido, privado) conforme especificado
# Garanta que todos os métodos lidem com casos de borda de forma apropriada (depósitos negativos, etc.)
