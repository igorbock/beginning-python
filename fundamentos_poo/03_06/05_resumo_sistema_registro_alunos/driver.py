...
# student.py - Implemente a classe Student com encapsulamento adequado
# studentregistry.py - Implemente a classe StudentRegistry para gerenciar alunos
# Siga os comentários TODO detalhados em cada arquivo para orientação passo a passo. 
# Sua implementação será testada contra casos de teste abrangentes que verificam:

# Validação adequada de atributos e tratamento de erros
# Cálculo correto de médias de notas
