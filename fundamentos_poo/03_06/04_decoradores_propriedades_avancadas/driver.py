# Neste desafio, você implementará uma classe Rectangle com encapsulamento adequado e validação de propriedades.

# rectangle.py - Este é o arquivo que você precisa editar, contendo comentários TODO para guiar sua implementação
# driver.py - Contém cenários de teste extensivos (não modifique)
# Implemente atributos privados para _width e _height
# Crie propriedades para width e height com validação (devem ser positivas)
# Levante mensagens ValueError apropriadas conforme especificado nos TODOs
# Importante: Verifique se o valor é menor ou igual a 0, então levante o erro (isso garante comportamento consistente)
# Implemente propriedades somente leitura para area e perimeter
# Crie uma propriedade dimensions com funcionalidade de getter, setter e deleter conforme descrito nos TODOs
# Importante: No setter, use a sintaxe de desempacotamento de tupla: width, height = dimensions
