# Neste desafio, você implementará um sistema de mensagens seguro com testes abrangentes para validar sua solução.

# Você precisa editar securemessenger.py para implementar a classe SecureMessenger seguindo os princípios de ocultação de informação. 
# O arquivo contém comentários TODO detalhados para guiar sua implementação.

# Os requisitos principais incluem:

# Encapsulamento adequado de credenciais e mensagens
# Autenticação antes de permitir operações de mensagem
# Monitoramento de segurança através do rastreamento de tentativas de login
# Mensagens de retorno precisas conforme especificado nos TODOs
