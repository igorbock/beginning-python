...
# unknownshape.py - Crie uma classe não derivada que demonstra duck typing
# shapecalculator.py - Implemente a funcionalidade da calculadora
# Siga os comentários TODO em cada arquivo para orientação passo a passo. 
# A suíte de testes abrangente ajudará você a entender o comportamento esperado e garantir que sua 
# implementação atenda a todos os requisitos corretamente.
