# Neste desafio, você implementará um sistema de reprodutor de mídia com interfaces.

# Você precisa editar os seguintes arquivos:

# playable.py - Implemente as classes base abstratas (interfaces)
# song.py - Implemente a classe Song
# video.py - Implemente a classe Video
# mediaplayer.py - Implemente a classe MediaPlayer
# Cada arquivo contém comentários TODO detalhados para guiar sua implementação. 
# Siga esses comentários para criar um sistema de reprodutor de mídia completo com herança 
# adequada e implementação de interfaces.
