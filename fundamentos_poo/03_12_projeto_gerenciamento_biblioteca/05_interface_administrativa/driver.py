# Neste desafio, você implementará funções administrativas para um sistema de gerenciamento de biblioteca.

# Você precisará modificar o arquivo library.py para adicionar um método get_statistics à classe Library que 
# retorna um dicionário com estatísticas importantes sobre o estado da biblioteca. 
# Os detalhes da implementação são fornecidos nos comentários TODO dentro do arquivo.

# As estatísticas devem incluir:

# Número total de livros
# Contagem de livros disponíveis
# Contagem de livros emprestados
# Contagem total de usuários
# Número de usuários com livros emprestados
# Os arquivos book.py e user.py contêm classes pré-implementadas com as quais sua solução irá interagir. 
# Embora você possa revisar esses arquivos para entender a estrutura do sistema, sua implementação deve se 
# concentrar no arquivo library.py.
