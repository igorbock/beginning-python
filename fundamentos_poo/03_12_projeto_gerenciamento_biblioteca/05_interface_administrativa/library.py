...
class Library:
    ...
    def get_statistics(self):
        ...
        for u in self.users:
            if u.books_borrowed:
                users_with_books += 1
        return {"total_books": total_books, "available_books": available_books, "borrowed_books": borrowed_books, "total_users": total_users, "users_with_books": users_with_books}
