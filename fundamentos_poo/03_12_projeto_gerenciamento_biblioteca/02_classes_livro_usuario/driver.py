# Neste desafio, você implementará a classe Book para um sistema de gerenciamento de biblioteca usando uma 
# estrutura de múltiplos arquivos com cobertura de testes abrangente.

# Edite book.py para implementar a classe Book seguindo os comentários TODO. A implementação deve:

# Inicializar com os parâmetros title, author e isbn
# Rastrear o status de disponibilidade e as informações do locatário
# Implementar uma representação de string adequada
