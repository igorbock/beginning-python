# Neste desafio, você implementará um sistema de gerenciamento de biblioteca com funcionalidade de busca de livros.

# Você trabalhará com três arquivos editáveis:

# book.py - Contém a definição da classe Book
# user.py - Contém a definição da classe User
# library.py - Contém a classe Library onde você implementará a funcionalidade de busca
# Siga os comentários TODO em cada arquivo para implementar a funcionalidade necessária. 
# Sua principal tarefa é adicionar um método search_by_title à classe Library que realize 
# buscas insensíveis a maiúsculas e minúsculas nos títulos dos livros.
