# Neste desafio, você implementará um sistema de gerenciamento de biblioteca com funcionalidade de empréstimo.

# Implemente a funcionalidade necessária nos seguintes arquivos:

# book.py - Contém a definição da classe Book
# user.py - Contém a definição da classe User
# library.py - Contém a classe Library onde você implementará o método borrow_book
# Siga os comentários TODO em cada arquivo para orientações de implementação passo a passo. 
# O método borrow_book deve lidar com vários cenários, incluindo livro/usuário não encontrado e 
