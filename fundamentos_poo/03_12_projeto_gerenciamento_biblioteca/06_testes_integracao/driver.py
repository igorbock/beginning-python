# Neste desafio, você implementará um sistema de biblioteca de múltiplos arquivos com cobertura de 
# testes abrangente. Você trabalhará com três arquivos somente leitura e um arquivo editável que 
# contém comentários TODO detalhados orientando sua implementação:

# book.py - Contém a definição da classe Book
# user.py - Contém a classe User que você precisa implementar
# library.py - Contém a definição da classe Library
