# Neste desafio, você implementará um sistema de criação de pessoas com cobertura de testes abrangente.

# Você precisa editar apenas o arquivo person_creator.py, seguindo os comentários TODO que guiam sua implementação. 
# O arquivo contém uma estrutura de classe para criar e gerenciar objetos de pessoa com várias propriedades.
