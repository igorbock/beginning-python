# Neste desafio, você implementará uma função utilitária de números flexível.

# Edite o arquivo number_utils.py para implementar a função sum_all_numbers que aceita qualquer 
# número de argumentos numéricos e retorna a soma deles. A função deve:

# Retornar 0 se nenhum argumento for fornecido
# Exibir "Error: All arguments must be numbers" e retornar None se quaisquer argumentos não numéricos forem fornecidos
# O arquivo number_utils.py contém comentários TODO detalhados para guiar sua implementação. 
# Siga esses comentários cuidadosamente para garantir que sua solução atenda a todos os requisitos.
