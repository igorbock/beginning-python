# Neste desafio, você implementará uma classe CustomList totalmente funcional que imita o comportamento da 
# lista integrada do Python, demonstrando seu entendimento de métodos especiais.

# Edite apenas o arquivo customlist.py seguindo os comentários TODO que guiam sua implementação passo a passo.

# Sua implementação deve suportar:

# Inicialização com itens opcionais
# Indexação (obtendo/definindo valores)
# Verificação de comprimento com len()
# Adição com outras listas
# Representação em string
# Iteração e verificações de contenção
# Métodos: append, pop e clear
