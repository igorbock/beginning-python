# Neste desafio, você implementará uma classe Deck que simula um baralho de cartas com funcionalidade abrangente e 
# convenções adequadas do Python.

# Você só precisa editar o arquivo deck.py. Siga os comentários TODO no código que o guiam na implementação de:
...
# Teste de associação ("AS" in deck)
