# Neste desafio, você implementará a classe State em state.py com encapsulamento e métodos adequados. 
# O arquivo contém comentários TODO detalhados para guiar sua implementação passo a passo.

# A suíte de testes foi projetada para verificar se sua implementação atende a todos os requisitos e 
# lida com condições excepcionais corretamente. Use os resultados dos testes para entender o 
# comportamento esperado e refinar sua solução.
