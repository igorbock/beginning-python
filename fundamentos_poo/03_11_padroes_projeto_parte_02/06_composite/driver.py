# Neste desafio, você implementará uma estrutura de sistema de arquivos usando o padrão de projeto Composite. 
# O padrão Composite permite compor objetos em estruturas de árvore para representar hierarquias parte-todo, tratando objetos individuais e composições de objetos de maneira uniforme.
...
# Trate os casos de erro apropriadamente
