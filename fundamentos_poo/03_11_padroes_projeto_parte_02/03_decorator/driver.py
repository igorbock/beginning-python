# Neste desafio, você implementará o padrão de projeto Decorator para criar um sistema flexível de 
# pedidos de café para uma cafeteria. O padrão Decorator permite que o comportamento seja adicionado a 
# objetos individuais dinamicamente, sem afetar o comportamento de outros objetos da mesma classe.
...
# Complete a classe abstrata Beverage e suas implementações concretas em beverage.py
# Implemente a classe abstrata CondimentDecorator e os decoradores concretos em condiment_decorator.py
# Implemente cenários de teste em driver.py para verificar sua implementação
