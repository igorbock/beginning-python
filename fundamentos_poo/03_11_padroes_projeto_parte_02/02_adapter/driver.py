# Neste desafio, você implementará o padrão de design Adapter para integrar sistemas legados com uma 
# arquitetura de aplicação moderna. O padrão Adapter permite que objetos com interfaces incompatíveis 
# trabalhem juntos, criando um invólucro (adapter) que traduz uma interface para outra.

# Sua empresa possui um sistema legado de análise e visualização de dados que precisa ser integrado a uma 
# nova plataforma de análise moderna. Os componentes legados possuem interfaces que são incompatíveis com 
# o novo sistema. Em vez de reescrever o código legado (o que seria arriscado e caro), você foi encarregado de 
# criar adaptadores para fazer esses componentes funcionarem com o novo sistema.

# Você precisa:

# Entender as interfaces modernas definidas em interfaces.py (este arquivo não pode ser modificado)
# Examinar os componentes legados em legacy_system.py (este arquivo não pode ser modificado)
# Implementar classes adaptadoras em adapters.py que tornem os componentes legados compatíveis com as interfaces modernas
# Criar um sistema moderno em modern_system.py que utilize essas interfaces
